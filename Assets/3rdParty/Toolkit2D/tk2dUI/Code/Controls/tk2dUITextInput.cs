...
public class tk2dUITextInput : MonoBehaviour
{
    ...
    private void InputSelected()
    {
		...
		if (Application.platform != RuntimePlatform.WindowsEditor &&
			...
			/// <summary>
			/// tk2d is forcing the android native keyboard to show the native text label input. 
			/// In order to avoid this the hideInput was changed to true. 
			/// (we haven't seen the mentioned "key bug").
			/// </summary>
	...
	/// <summary>
	/// return a clone of the keyborad instance in order to have control over the keyboard states
	/// </summary>
	public TouchScreenKeyboard KeyboardClone(){
		#if TOUCH_SCREEN_KEYBOARD
		TouchScreenKeyboard _keyboard = keyboard;
		return _keyboard;
		#else
		return null;
		#endif
