...
public class tk2dUIScrollableArea : MonoBehaviour
{
	...
	/// <summary>
	/// If true, players can scroll the area even if it's content length is less than the visible area.
	/// </summary>
	[SerializeField]
    ...
    private const float SWIPE_SCROLLING_FIRST_SCROLL_THRESHOLD = 2.0f; //at what point swipe scrolling will start moving the list
