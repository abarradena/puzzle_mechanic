...
public class tk2dUIToggleButtonGroupEditor : Editor
{
    ...
    public override void  OnInspectorGUI()
    {
		...
		SerializedProperty dispatchProperty = serializedObj.FindProperty ("dispatchOnAwake");
		dispatchProperty.boolValue = EditorGUILayout.Toggle("OnChange on Awake", dispatchProperty.boolValue);
